...
class SitemapController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        $urls[] = ['loc' => $this->generateUrl('acceuil_index')];
        $urls[] = ['loc' => $this->generateUrl('logement_index')];
        $urls[] = ['loc' => $this->generateUrl('actualites_articles')];
        $urls[] = ['loc' => $this->generateUrl('contact_index')];
        $urls[] = ['loc' => $this->generateUrl('user_registration')];
        $urls[] = ['loc' => $this->generateUrl('connexion_index')];
        $urls[] = ['loc' => $this->generateUrl('rgpd_index')];
        $urls[] = ['loc' => $this->generateUrl('mentions_index')];
